...
const { PULSE_DURATION_MS, PULSE_MIN_OPACITY, REPORT_STAT_CARDS } = AppConstants.SKELETON;
        ...
        <View style={styles.volumeCard}>
          <View style={styles.volumeRow}>
            {Array.from({ length: 3 }).map((_, i) => (
              <View key={i} style={styles.volumeItem}>
                <View style={[styles.line, { width: 36, height: 22 }]} />
                <View style={[styles.line, { width: 50, height: 11, marginTop: 6 }]} />
              </View>
            ))}
          </View>
        </View>
