...
import type { AddStockMoveComponentProps } from '../../../types/stockMovements.types';
import { styles } from './styles';

const { PURCHASE, SALE, MANUAL } = AppConstants.MOVEMENT_SOURCE;
const { IN, OUT } = AppConstants.MOVEMENT_TYPE;

export const AddStockMoveComponent = ({
  submitting,
  values,
  errors,
  touched,
    ...
    <SafeAreaView style={styles.root} edges={['top']}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>{t('stockMovements.add.title')}</Text>
        </View>
      ...
      >
        ...
        <AppDatePicker
          ...
          placeholder={t('stockMovements.add.datePlaceholder')}
          helper={t('stockMovements.add.dateHint')}
      ...
      <AppBottomBar>
        <View style={styles.bottomBarRow}>
          ...
          <View style={styles.flexBtn}>
            <AppButton
              variant="primary"
              label={t('stockMovements.addStockMove')}
              onPress={onSubmit}
              loading={submitting}
              disabled={submitting}
              size="lg"
