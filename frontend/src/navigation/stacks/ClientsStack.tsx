...
export const ClientsStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    <Stack.Screen name={S.CLIENT_LIST} component={Placeholder} />
    <Stack.Screen name={S.CLIENT_DETAIL} component={Placeholder} />
    <Stack.Screen name={S.CLIENT_FORM} component={Placeholder} />
  </Stack.Navigator>
);
